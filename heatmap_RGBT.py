...
class yolo_heatmap:
    def __init__(self, weight, device, method, layer, backward_type, conf_threshold, ratio, show_result, renormalize,
                 task, img_size, use_simotm='RGBRGB6C', channels=6):
        ...
        print("len(model.model):", len(model.model))
    ...
    def __call__(self, img_path, save_path):
        ...
        if os.path.isdir(img_path):  #文件夹读取
            for img_path_ in os.listdir(img_path):
                if img_path_.endswith("jpg"):
...
def get_params():
    params = {
        ...
        'weight': '/home/zhangquan/clg/yolocmssm2/results/150epoch-yolorgbt-adjuster/weights/best.pt',
        ...
        # 'layer': [30, 33, 36, 39, 42],  # [10, 12, 14, 16, 18],    [30, 33, 36, 39, 42]
        'layer': [22, 27, 32], #yolorgbt-adjuster，热力图使用的是yaml文件中的层级
        'backward_type': 'all',
...
if __name__ == '__main__':
    ...
    model(r"/media/data5/zhangquan/clg/Anti-UAV-RGBT-640/visible/test", 'heatmap/yolorgbt-adjuster')
