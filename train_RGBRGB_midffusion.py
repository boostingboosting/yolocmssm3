...
if __name__ == '__main__':
    model = YOLO('ultralytics/cfg/models/11-RGBT/yolo11x-RGBT-midfusion.yaml')  # 只是将yaml里面的 ch设置成 6 ,红外部分改为 SilenceChannel, [ 3,6 ] 即可
    # model.load(r'yolov8n.pt') # loading pretrain weights
    # model = YOLO("/home/zhangquan/clg/yolocmssm2/runs/AntiUAV/AntiUAV-150epoch-yolo11s-RGBRGB6C-midfusion-P3/weights/last.pt")
    model.train(data=R'ultralytics/cfg/datasets/AntiUAV-rgbt.yaml',
                ...
                name='AntiUAV-150epoch-yolo11x-RGBRGB6C-midfusion',
                )