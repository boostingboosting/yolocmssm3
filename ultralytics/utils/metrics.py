...
def bbox_iou(box1, box2, xywh=True, GIoU=False, DIoU=False, CIoU=False, EIoU=False, SIoU=False, ShapeIoU=False,
    ...
    """
    # print("box1 dtype:", box1.dtype)
    # print("box1 has nan:", torch.isnan(box1).any().item())
    # print("box1 has inf:", torch.isinf(box1).any().item())
    # box1 = box1.float()
    # box2 = box2.float()
    # print("box1 shape:", box1.shape)
    # print("box1:", box1)
    assert box1.size(-1) == 4, f"Expected last dim=4, got {box1.size(-1)}"
    # Get the coordinates of bounding boxes
