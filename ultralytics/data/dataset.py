...
class YOLODataset(BaseDataset):
    ...
    def cache_labels(self, path=Path("./labels.cache")):
        ...
        with ThreadPool(NUM_THREADS) as pool:
            ...
            for im_file, lb, shape, segments, keypoint, nm_f, nf_f, ne_f, nc_f, msg, offset, area, center_point, cls_rgb, boxes_rgb, boxes_ir in pbar:
                nm += nm_f
                nf += nf_f
                ne += ne_f
                nc += nc_f
    ...
    def get_labels(self):
        ...
        # print("len(self.im_files):", len(self.im_files),"333333333333333333333333")  #20393,只有rgb模态的
