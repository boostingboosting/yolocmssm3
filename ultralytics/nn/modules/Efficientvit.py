    ...
    def __init__(self, mode):
        ...
        if mode == 'b0':
            ...
            self.enc_rgb.init_weights(
                # pretrained="/home/zhangquan/clg/CMSSM/backbone/efficientvit/efficientvit_seg_b0_cityscapes.pt")
                pretrained=None)
        ...
        if mode == 'b2':
            ...
            self.enc_rgb.init_weights(
                # pretrained="/home/zhangquan/clg/CMSSM/backbone/efficientvit/efficientvit_b2_r288.pt")
                pretrained=None)
            self.enc_t.init_weights(
                # pretrained="/home/zhangquan/clg/CMSSM/backbone/efficientvit/efficientvit_b2_r288.pt")
                pretrained=None)
        ...
        if mode == 'b3':
            ...
            self.enc_rgb.init_weights(
                # pretrained="/home/zhangquan/clg/CMSSM/backbone/efficientvit/efficientvit_b3_r288.pt")
                pretrained=None)
            self.enc_t.init_weights(
                # pretrained="/home/zhangquan/clg/CMSSM/backbone/efficientvit/efficientvit_b3_r288.pt")
                pretrained=None)
        ...
        if mode == 'l1':
            ...
            self.enc_rgb.init_weights(
                # pretrained="/home/zhangquan/clg/CMSSM/backbone/efficientvit/efficientvit_l1_r224.pt")
                pretrained=None)
            self.enc_t.init_weights(
                # pretrained="/home/zhangquan/clg/CMSSM/backbone/efficientvit/efficientvit_l1_r224.pt")
                pretrained=None)
        ...
        if mode == 'l2':
            ...
            self.enc_rgb.init_weights(
                # pretrained="/home/zhangquan/clg/CMSSM/backbone/efficientvit/efficientvit_l2_r384.pt")
                pretrained=None)
            self.enc_t.init_weights(
                # pretrained="/home/zhangquan/clg/CMSSM/backbone/efficientvit/efficientvit_l2_r384.pt")
                pretrained=None)
...
class Encoder_Efficientvit(nn.Module):
    def __init__(self, mode):
        ...
        if mode == 'b1':
            self.enc_rgb = efficientvit_backbone_b1()
            self.enc_rgb.init_weights(
                # pretrained="/home/zhangquan/clg/CMSSM/backbone/efficientvit/efficientvit_b1_r288.pt")
                pretrained=None)
